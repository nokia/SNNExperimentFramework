...
class tf_clusters():
    ...
    def get_idx(self, id: int) -> int:
        ...
        ----------
        id : int
            id of the cluster to get the index
    ...
    def update_closest(self, new_c_id: int,
        ...
        The computation procceds in 3 steps:
            ...
            3) Compute the closest cluster for the new_c_id and update the
               closest data structure
        ...
        with timeit_cnt("Step 1"):
            print(f"Step 1: clusters which have {old_c_id} as closest")
...
#         return tmp_rep
    ...
    def merge(self, u_id: int, v_id: int) -> None:
        ...
        with timeit_cnt("Merge clusters"):
            ...
            print(f"Merging {u_idx} and {v_idx}")
            if u_idx == v_idx:
