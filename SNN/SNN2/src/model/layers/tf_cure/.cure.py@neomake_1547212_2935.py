...
from SNN2.src.contextManagers.contextManagers import TimeitContext as TiT
...
class TfCURE:
    ...
    def special_case(self) -> None:
        """special_case.

        This function takes care of the special case when only one cluster is
        requested.
        """
